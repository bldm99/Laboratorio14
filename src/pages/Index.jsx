...
function Index(){
    return(
            ...
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <Link className="navbar-brand ps-3"  to="/login"  >Login</Link>
                <Link className="navbar-brand ps-3" to="/forgotpassword"  >Forgot Password?</Link>
                <Link className="navbar-brand ps-3"  to="/register"  >Register</Link>
                <Link className="navbar-brand ps-3"  to="/*"  >NoFound</Link>
